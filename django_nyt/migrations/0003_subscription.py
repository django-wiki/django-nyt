        ...
        migrations.CreateModel(
            name='Subscription', fields=[
                ('id', models.AutoField(
                    ...
                    to_field='id', to='django_nyt.Settings', on_delete=models.CASCADE)), ('notification_type', models.ForeignKey(
                    to_field='key', to='django_nyt.NotificationType', on_delete=models.CASCADE)), ('object_id', models.CharField(
                    ...
                    to_field='id', to='django_nyt.Notification', blank=True, null=True, on_delete=models.CASCADE)), ], options={
